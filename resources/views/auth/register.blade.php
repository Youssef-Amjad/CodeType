<x-layout-auth title="Register" description="Register description" keywords="Register keywords">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('auth.register') }}" method="POST">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Alordy account ? <a href="{{ route('auth.login') }}" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Login</a>
                        </p>
                    </form>
                </div>
            </div>
