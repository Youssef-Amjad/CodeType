<footer class="relative pt-20 lg:pt-[120px] pb-5 lg:pb-5 max-lg:px-5 border-t-2 border-t-indigo-600 overflow-hidden">
    <div class="container overflow-hidden">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div class="w-full mb-10">
                    <a href="#" class="flex items-center mb-5 space-x-3 cursor-pointer">
                        <h1 class="text-2xl font-bold">Code Type</h1>
                    </a>
                    <p class="text-base mb-7">
                        Code Type is an educational platform that is always in development
                    </p>
                    <div class="space-y-3">
                        ...
                        <p class="flex items-center text-sm font-medium text-dark">
                            ...
                            <span class="tracking-widest">(+20) 000000000</span>
                        </p>
                        <p class="flex items-center text-sm font-medium text-dark">
                            <span class="mr-3 text-primary">
                                <svg width="19" height="21" viewBox="0 0 19 21" class="fill-current">
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h1 class="mb-8 text-xl font-semibold">Learning paths</h1>
                    <ul class="max-md:ml-3">
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Fundamentals Course</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Front-End track</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Back-End track</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Mobile track</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Cyber Security track</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">DevOps track</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h1 class="mb-8 text-xl font-semibold">Learn now</h1>
                    <ul class="max-md:ml-3">
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Articles</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Educational Courses</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Course Assignments</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Examples, Applications</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Software challenges</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Developer tools</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h1 class="mb-8 text-xl font-semibold">Study plans</h1>
                    <ul class="max-md:ml-3">
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">C++ Plan</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">HTML plan</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">CSS plan</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">JavaScript plan</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Python plan</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">PHP plan</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h1 class="mb-8 text-xl font-semibold">Tools</h1>
                    <ul class="max-md:ml-3">
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Minify HTML & CSS & JS</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">CSS Color Pick</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Hash JS Compiler</a></li>
                        <li><a href="{{ route('home') }}" class="inline-block mb-2 font-medium hover:text-primary">Fix Image</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h1 class="mb-8 text-xl font-semibold">Quick Links</h1>
                    <ul class="max-md:ml-3">
                        <li><a href="#" class="inline-block mb-2 font-medium hover:text-primary">Premium Support</a></li>
                        <li><a href="#" class="inline-block mb-2 font-medium hover:text-primary">Our Services</a></li>
                        <li><a href="#" class="inline-block mb-2 font-medium hover:text-primary">Know Our Team</a></li>
                        <li><a href="#" class="inline-block mb-2 font-medium hover:text-primary">Download App</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul class="max-md:ml-3">
                        ...
                        <li><a href="#" class="inline-block mb-2 hover:text-primary">Our Products</a></li>
                        <li><a href="#" class="inline-block mb-2 hover:text-primary">User Flow</a></li>
                        <li><a href="#" class="inline-block mb-2 hover:text-primary">User Strategy</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div>
        ...
        <span class="absolute left-1/2 top-1/2 z-[-1]">
            <svg width="350" height="350" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear_1179_4" x1="-1.63917e-06" y1="37.5" x2="75" y2="37.5" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#13C296" stop-opacity="0.02" />
                        <stop offset="1" stop-color="blue" stop-opacity=".02" />
                    </linearGradient>
                </defs>
            </svg>
        </span>
