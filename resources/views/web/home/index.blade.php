<x-layout-web title="Code Type | Home" description="Home" keywords="python,javascript,js,git,github,website,web,development,course,courses,html,css,react,redux,api,front,back,end,learn,tutorial,programming">
    ...
    <main>
        ...
        <section class="relative py-12 overflow-hidden bg-gray-50 sm:py-16 lg:py-20">
            ...
            <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="flex flex-col items-center justify-between md:flex-row">
                    <div class="flex flex-col items-center text-center md:text-left md:flex-row md:items-start sm:max-w-md lg:max-w-2xl">
                        ...
                        <h2 class="mt-4 text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl md:ml-4 lg:ml-8 md:mt-0">Ready to start your educational journey?</h2>
                    </div>
                    <div class="flex flex-col items-center mt-8 space-y-6 md:mt-0"><a target="_blank" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-full shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700" role="button" href="https://app.chaibuilder.com/register">Create account</a>
                        <p class="text-sm font-normal text-gray-500">Get started quickly with the best learning platform</p>
                    </div>
                </div>
            </div>
        </section>
