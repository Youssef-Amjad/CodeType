<x-section name="hero" class="hero">
    ...
    <div class="md:w-1/2 max-md:text-center">
        ...
        <p class="mb-8 font-semibold text-gray-800 dark:text-gray-300 max-md:px-2" data-aos="fade-up" data-aos-delay="350">
            Code Type is a training platform that offers courses in all fields: Front-end, Back-end, Cyber Security, DevOps, Mobile Development, Game Development, Ui-Ux Designer
        </p>
        <a href="#" class="inline-block py-5 px-16 bg-[#372cfa] text-white font-semibold cursor-pointer border-none outline-none transition-all rounded-2xl hover:bg-[#070439]">Get Started</a>
    </div>
</x-section>
